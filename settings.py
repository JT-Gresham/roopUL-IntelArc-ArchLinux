...
class Settings:
    ...
    def load(self):
        ...
        self.output_video_format = self.default_get(data, 'output_video_format', 'mkv')
        ...
        self.max_threads = self.default_get(data, 'max_threads', 512)
        self.memory_limit = self.default_get(data, 'memory_limit', 0)
        self.provider = self.default_get(data, 'provider', 'xpu')
